...
export type Database = {
  ...
  public: {
    Tables: {
      // NOTE: hand-extended for plan 007 (scheduler role + appointments).
      // Regenerated by the maintainer after migrations 027/028 are applied.
      appointments: {
        Row: {
          address: string | null
      ...
      // NOTE: hand-extended for plan 009 (collaborator cycle calendar).
      // Regenerated by the maintainer after migration 029 is applied.
      collaborator_cycles: {
        Row: {
